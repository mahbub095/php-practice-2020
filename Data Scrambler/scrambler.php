...
$task = 'encode';
//array te dekhar jonno
if(isset($_GET['task']) && $_GET['task']!=''){
     $task = $_GET['task'];
     
   //  $mode = $_GET['mode']??'encode';
}
$original_key= 'abcdefghijklmnopqrstuvwxyz12345678';
$key= 'abcdefghijklmnopqrstuvwxyz12345678';
//shuffle er jonno
if('key' ==$task) {
    ...
    <div class="container">
        <div class="row">
            <div class="column column-60 column-offset-20">
                ...
                <p>
                    <a href="../php/scrambler.php?task=encode">Encode</a>
                    <a href="../php/scrambler.php?task=decode">Decode</a>
                    <a href="../php/scrambler.php?task=key">Generate Key</a>
